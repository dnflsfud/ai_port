...
def build_all_features(
    ...
    # S13.34: implied-vol surface block (S8 idiom); admission is gated at the
    # core-whitelist filter below, so OFF stays byte-identical.
    implied_vol = build_implied_vol_features(data)
